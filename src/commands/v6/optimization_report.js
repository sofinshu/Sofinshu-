...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_ent_optimization_report').setLabel('ðŸ„ Sync Enterprise Data').setStyle(ButtonStyle.Secondary));
