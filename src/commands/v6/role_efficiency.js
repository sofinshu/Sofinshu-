...
module.exports = {
  ...
  async execute(interaction) {
    try {
      ...
      await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_ent_role_efficiency').setLabel('ðŸ„ Sync Enterprise Data').setStyle(ButtonStyle.Secondary));
