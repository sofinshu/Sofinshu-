...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v4_link_blocker').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
