...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v4_strike_check').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
