...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (modChannel) {
      ...
      const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v4_alert_mod').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
