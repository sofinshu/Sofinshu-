    ...
    async execute(interaction) {
        try {
            ...
            if (!userData || !userData.staff) {
                return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v3_skill_tree').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
            ...
            await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v3_skill_tree').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
