...
module.exports = {
  ...
  async execute(interaction) {
    try {
      ...
      if (!member) {
        return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v3_role_assign').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
      ...
      await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v3_role_assign').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
