...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v5_server_trends').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
