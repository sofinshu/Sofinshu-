...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const embed = createEnterpriseEmbed()
      ...
      ;
    await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_zen_rank_animation').setLabel('ðŸ„ Refresh Hyper-Apex Metrics').setStyle(ButtonStyle.Secondary));
