...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const embed = createEnterpriseEmbed()
      ...
      ;
    await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_zen_progress_animation').setLabel('ðŸ„ Refresh Hyper-Apex Metrics').setStyle(ButtonStyle.Secondary));
