...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_zen_set_branding').setLabel('� Refresh Hyper-Apex Metrics').setStyle(ButtonStyle.Secondary));
