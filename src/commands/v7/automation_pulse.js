...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            if (interaction.deferred || interaction.replied) const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_ent_automation_pulse').setLabel('�� Sync Enterprise Data').setStyle(ButtonStyle.Secondary));
