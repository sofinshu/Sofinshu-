...
module.exports = {
  ...
  async execute(interaction, client) {
    try {
      ...
      if (!staffSystem) {
        return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_bonus_points').setLabel('ğŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
      ...
      await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_bonus_points').setLabel('ğŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
