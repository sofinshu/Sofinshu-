  ...
  async execute(interaction) {
    try {
      ...
      if (!interaction.member.permissions.has('ManageGuild')) {
        const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_addReputation').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
