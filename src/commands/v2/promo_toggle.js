...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_promo_toggle').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
