  ...
  async execute(interaction) {
    try {
      ...
      if (subcommand === 'add') {
        ...
        return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_task_assign').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
      ...
      if (interaction.deferred || interaction.replied) {
        await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_task_assign').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
