...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_set_requirements_plus').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
