...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (sub === 'role') {
            ...
            return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_setup_promo').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
