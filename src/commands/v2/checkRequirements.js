  ...
  async execute(interaction) {
    try {
      ...
      if (!userData || !userData.staff) {
        return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_checkRequirements').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
      ...
      await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_checkRequirements').setLabel('ðŸ„ Sync Live Data').setStyle(ButtonStyle.Secondary));
