    ...
    async execute(interaction) {
        try {
            ...
            if (alerts.enabled && (!alerts.channelId || !alerts.threshold)) {
                return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_activity_alert').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
            ...
            await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_activity_alert').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
