...
module.exports = {
    ...
    async execute(interaction, client) {
        try {
            ...
            if (!user || !user.staff) {
                return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_promo_progress').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
            ...
            await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_promo_progress').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
