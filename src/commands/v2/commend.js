    ...
    async execute(interaction) {
        try {
            ...
            if (targetUser.id === interaction.user.id) {
                return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_commend').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
            ...
            await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_commend').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
