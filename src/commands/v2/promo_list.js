    ...
    async execute(interaction) {
        try {
            ...
            if (!guild || !guild.promotionRequirements) {
                return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_promo_list').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
            ...
            await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_btn_promo_list').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
